...
// Create an instance of the Blynk client
BlynkSimpleEsp32Client blynk(auth, BLYNK_TEMPLATE_ID, BLYNK_TEMPLATE_NAME);

// Create an instance of the MPU6050 sensor
Adafruit_MPU6050 mpu;

// Create an instance of the Blynk client
BlynkSimpleEsp32Client blynk(BLYNK_AUTH_TOKEN);
...
void loop() {
  ...
  blynk.virtualWrite(3, g.gyro.x);
  blynk.virtualWrite(4, g.gyro.y);
  blynk.virtualWrite(5, g.gyro.z);
